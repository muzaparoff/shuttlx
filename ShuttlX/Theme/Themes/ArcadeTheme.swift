...
extension AppTheme {
    static let arcade = AppTheme(
        ...
        fonts: ThemeFonts(
            ...
            watchTimerDisplay: .system(size: 52, weight: .heavy, design: .monospaced),
            watchMetricDisplay: .system(size: 40, weight: .heavy, design: .rounded),
            watchMetricSecondary: .system(size: 28, weight: .bold, design: .rounded),
            watchStepLabel: .system(size: 13, weight: .heavy),
            watchControlIcon: .system(size: 26, weight: .bold),
            watchControlLabel: .system(size: 13, weight: .bold),
