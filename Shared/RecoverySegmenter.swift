...
public enum SegmenterProfile: Sendable {
...
public enum SegmentState: String, Sendable {
...
public enum SegmenterEvent: Sendable {
...
public struct RecoverySegmenter {
    public let config: SegmenterConfig

    public private(set) var state: SegmentState = .idle
    public private(set) var setNumber: Int = 0
    public private(set) var workStartTime: Date?
    ...
    public private(set) var restStartTime: Date?
    ...
    public init(config: SegmenterConfig = SegmenterConfig()) {
        self.config = config
    }
    ...
    public mutating func tick(hr: Int, activity: DetectedActivity, maxHR: Double, now: Date) -> [SegmenterEvent] {
