...
class TimerSyncVerificationTests: XCTestCase {
    ...
    func testCompleteWorkflowWithCriticalFixes() throws {
        ...
        XCTAssertGreaterThan(warmupIntervals.count, 0, "Should have warmup intervals")
        ...
        XCTAssertGreaterThan(cooldownIntervals.count, 0, "Should have cooldown intervals")
