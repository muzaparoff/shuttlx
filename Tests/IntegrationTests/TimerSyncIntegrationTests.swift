...
final class TimerSyncIntegrationTests: XCTestCase {
    ...
    func testWorkoutTimerIntegration() throws {
        ...
        // Verify warmup and cooldown are included
        XCTAssertTrue(intervals.contains { $0.type == .warmup }, "Should have warmup")
        XCTAssertTrue(intervals.contains { $0.type == .cooldown }, "Should have cooldown")
    ...
    private func generateExpectedIntervals(from program: TrainingProgram) -> [MockWorkoutInterval] {
        ...
        // Add warmup
        intervals.append(MockWorkoutInterval(type: .warmup, duration: 300)) // 5 min
        
        // Calculate cycles
        let totalWorkoutTime = program.totalDuration * 60 - 600 // minus warmup/cooldown
        ...
        // Add cooldown
        intervals.append(MockWorkoutInterval(type: .cooldown, duration: 300)) // 5 min
