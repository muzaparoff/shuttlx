...
| T1.1 | 1 | Watch-sized spec — Synthwave | product-designer | TODO | design/proposals/timer-theme-redesigns/synthwave-watch.md | |
| T1.2 | 1 | Watch-sized spec — Mixtape | product-designer | TODO | design/proposals/timer-theme-redesigns/mixtape-watch.md | |
| T1.3 | 1 | Watch-sized spec — Arcade | product-designer | TODO | design/proposals/timer-theme-redesigns/arcade-watch.md | |
| T1.4 | 1 | Watch-sized spec — Classic Radio | product-designer | TODO | design/proposals/timer-theme-redesigns/classic-radio-watch.md | |
| T1.5 | 1 | Watch-sized spec — VU Meter | product-designer | TODO | design/proposals/timer-theme-redesigns/vu-meter-watch.md | |
| T1.6 | 1 | Watch-sized spec — Neovim | product-designer | TODO | design/proposals/timer-theme-redesigns/neovim-watch.md | |
| T2.1 | 2 | Add `themedHero` primitive on iOS | senior-ios-developer | TODO | iPhoneWorkoutTimerView.swift | Mirror existing FM Tuner branch pattern |
| T2.2 | 2 | Add `themedHero` primitive on watch | swiftui-watchos-specialist | TODO | TrainingView.swift | |
